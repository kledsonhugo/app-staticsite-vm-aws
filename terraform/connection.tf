resource "aws_key_pair" "ec2_key_pair" {
  ...
  public_key = file("/home/iansoares/.ssh/id_rsa.pub")
}
...
resource "null_resource" "front_end_apply" {
  provisioner "remote-exec" {
    inline = [
      ...
      "    git clone https://github.com/ian-soares/app-static-site-ec2 /tmp/repo-atualizado",
  ...
  connection {
    ...
    private_key = file("/home/iansoares/.ssh/id_rsa")
  }
